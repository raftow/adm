...
class AcademicProgram extends AdmObject
{
        ...
        protected function getOtherLinksArray($mode, $genereLog = false, $step = 'all')
        {
                ...
                if ($mode == 'mode_programRequirementList') {
                        unset($link);
                        $link = array();
                        $title = 'إضافة متطلب برنامج جديد';
                        $title_detailed = $title . 'لـ : ' . $displ;
                        $link['URL'] = "main.php?Main_Page=afw_mode_edit.php&cl=ProgramRequirement&currmod=adm&sel_academic_program_id=$my_id";
                        $link['TITLE'] = $title;
                        $link['UGROUPS'] = array();
                        $otherLinksArray[] = $link;
                }
