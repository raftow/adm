<?php
// rafik 7/7/21 :
// ALTER TABLE `adm_file` CHANGE `afile_size` `afile_size` INT(16) NULL DEFAULT NULL; 
// ALTER TABLE `adm_file` CHANGE `original_name` `original_name` varchar(255); 
// ALTER TABLE `adm_file` CHANGE `afile_name` `afile_name` varchar(255);
...
zoomWindowOffety:-200
        ...
        public function showMySelf($style="")
        {
           global $lang;
               ...
               $span_edit = "<span><a href='main.php?Main_Page=afw_mode_display.php&cl=AdmFile&currmod=adm&id=$my_id'>$display</a></span><br>";
