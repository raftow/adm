...
class ConferenceRole extends AFWObject{

        public static $MY_ATABLE_ID=14010; 
  
        public static $DATABASE		= "nauss_adm";
        public static $MODULE		        = "adm";        
        public static $TABLE			= "conference_role";

	    public static $DB_STRUCTURE = null;
	
	    public function __construct(){
		parent::__construct("conference_role","id","adm");
            AdmConferenceRoleAfwStructure::initInstance($this);    
	    }
        
        public static function loadById($id)
        {
           $obj = new ConferenceRole();
