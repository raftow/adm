<?php
        ...
        public function afterMaj($id, $fields_updated)
        {
                ...
                $applicantAccountObj->where("applicant_id2 = '".$applicant_id."' and application_plan_id = '".$application_plan_id."' and application_simulation_id = '".$application_simulation_id."'");
