...
class ApplicantCourses extends AFWObject{

        public static $MY_ATABLE_ID=14014; 
  
        public static $DATABASE		= "nauss_adm";
        public static $MODULE		        = "adm";        
        public static $TABLE			= "applicant_courses";

	    public static $DB_STRUCTURE = null;
	
	    public function __construct(){
		parent::__construct("applicant_courses","id","adm");
            AdmApplicantCoursesAfwStructure::initInstance($this);    
	    }
        
        public static function loadById($id)
        {
           $obj = new ApplicantCourses();
