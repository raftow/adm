...
class ApplicantCvScore extends AFWObject{

        public static $MY_ATABLE_ID=14025; 
  
        public static $DATABASE		= "nauss_adm";
        public static $MODULE		        = "adm";        
        public static $TABLE			= "applicant_cv_score";

	    public static $DB_STRUCTURE = null;
	
	    public function __construct(){
		parent::__construct("applicant_cv_score","id","adm");
            AdmApplicantCvScoreAfwStructure::initInstance($this);    
	    }
        
        public static function loadById($id)
        {
           $obj = new ApplicantCvScore();
