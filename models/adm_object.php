...
class AdmObject extends AfwMomkenObject
{
    ...
    public static function getFieldsManagerMatrix($table_name, $field_name)
    {
        ...
        // if(($field_name=="mobile") and ($main_company=="nauss")) die("dbg::AdmObject::getFieldsManagerMatrix($table_name,$field_name) return=".var_export($return,true));
    ...
    public static function code_of_grade_scale_enum($lkp_id = null)
    {
        ...
        if ($lkp_id)
            return self::grade_scale()['code'][$lkp_id];
        else
            return self::grade_scale()['code'];
    }
    ...
    public static function code_of_applicant_decision_enum($lkp_id = null)
    {
        $lang = AfwLanguageHelper::getGlobalLanguage();
        if ($lkp_id)
            return self::applicant_decision()['code'][$lkp_id];
        else
            return self::applicant_decision()['code'];
    }
    ...
    public static function code_of_notification_channel_enum($lkp_id = null)
    {
        $lang = AfwLanguageHelper::getGlobalLanguage();
        if ($lkp_id)
            return self::notification_channel()['code'][$lkp_id];
        else
            return self::notification_channel()['code'];
    }
    ...
    public static function code_of_split_sorting_by_enum($lkp_id = null)
    {
        $lang = AfwLanguageHelper::getGlobalLanguage();
        if ($lkp_id)
            return self::split_sorting_by()['code'][$lkp_id];
        else
            return self::split_sorting_by()['code'];
    }
    ...
    {
        if ($lkp_id)
            return self::sorting_sens()['code'][$lkp_id];
        else
            return self::sorting_sens()['code'];
    }
    ...
    public static function application_status_code($application_status_enum)
    {
        ...
        foreach ($arr['code'] as $eid => $code) {
            if ($application_status_enum == $eid)
                return $code;
        }
    ...
    public static function application_status_enum()
    {
        ...
        $arr_list_of_application_status_enum['en'][1] = 'Incomplete';
        $arr_list_of_application_status_enum['ar'][1] = 'تقديم غير مكتمل';
        $arr_list_of_application_status_enum['code'][1] = 'pending';

        $arr_list_of_application_status_enum['en'][2] = 'Complete';
        ...
        $arr_list_of_application_status_enum['en'][6] = 'Rejected';
        $arr_list_of_application_status_enum['ar'][6] = 'مرفوض';
    ...
    {
        if ($lkp_id)
            return self::application_table()['code'][$lkp_id];
        else
            return self::application_table()['code'];
    }
    ...
    {
        if (!$one_training_period_enum)
            return true;
        if ($one_training_period_enum == 3)
            return true;
        if ($one_training_period_enum == $other_training_period_enum)
            return true;
    ...
    public static function reupload_enum()
    {
        ...
        $arr_list_of_reupload['en'][3] = 'Not required';
        $arr_list_of_reupload['ar'][3] = 'غير مطلوب';
    ...
    public static function list_of_aptitude_category_enum()
    {
        $lang = AfwLanguageHelper::getGlobalLanguage();
        return self::aptitude_category()[$lang];
    }

    public static function aptitude_category()
    {
        $arr_list_of_aptitude_category = array();
        ...
        $lookup = $classAC::getApplicantAptitudeCategoryLookup();

        foreach ($lookup as $id => $lookup_row) {
            $arr_list_of_aptitude_category['ar'][$id] = $lookup_row['ar'];
            $arr_list_of_aptitude_category['en'][$id] = $lookup_row['en'];
        }

        return $arr_list_of_aptitude_category;
    }
