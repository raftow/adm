...
class ProficiencyLevel extends AFWObject{

        public static $MY_ATABLE_ID=14019; 
  
        public static $DATABASE		= "nauss_adm";
        public static $MODULE		        = "adm";        
        public static $TABLE			= "proficiency_level";

	    public static $DB_STRUCTURE = null;
	
	    public function __construct(){
		parent::__construct("proficiency_level","id","adm");
            AdmProficiencyLevelAfwStructure::initInstance($this);    
	    }
        
        public static function loadById($id)
        {
           $obj = new ProficiencyLevel();
