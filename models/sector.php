...
class Sector extends AFWObject{

        public static $MY_ATABLE_ID=14015; 
  
        public static $DATABASE		= "nauss_adm";
        public static $MODULE		        = "adm";        
        public static $TABLE			= "sector";

	    public static $DB_STRUCTURE = null;
	
	    public function __construct(){
		parent::__construct("sector","id","adm");
            AdmSectorAfwStructure::initInstance($this);    
	    }
