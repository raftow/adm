...
class CvRubric extends AFWObject{

        public static $MY_ATABLE_ID=14009; 
  
        public static $DATABASE		= "nauss_adm";
        public static $MODULE		        = "adm";        
        public static $TABLE			= "cv_rubric";

	    public static $DB_STRUCTURE = null;
	
	    public function __construct(){
		parent::__construct("cv_rubric","id","adm");
            AdmCvRubricAfwStructure::initInstance($this);    
	    }
