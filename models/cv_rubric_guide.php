...
class CvRubricGuide extends AFWObject{

        public static $MY_ATABLE_ID=14026; 
  
        public static $DATABASE		= "nauss_adm";
        public static $MODULE		        = "adm";        
        public static $TABLE			= "cv_rubric_guide";

	    public static $DB_STRUCTURE = null;
	
	    public function __construct(){
		parent::__construct("cv_rubric_guide","id","adm");
            AdmCvRubricGuideAfwStructure::initInstance($this);    
	    }
        
        public static function loadById($id)
        {
           $obj = new CvRubricGuide();
