...
class CertificationLevel extends AFWObject{

        public static $MY_ATABLE_ID=14017; 
  
        public static $DATABASE		= "nauss_adm";
        public static $MODULE		        = "adm";        
        public static $TABLE			= "certification_level";

	    public static $DB_STRUCTURE = null;
	
	    public function __construct(){
		parent::__construct("certification_level","id","adm");
            AdmCertificationLevelAfwStructure::initInstance($this);    
	    }
        
        public static function loadById($id)
        {
           $obj = new CertificationLevel();
