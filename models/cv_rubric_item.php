...
class CvRubricItem extends AFWObject{

        public static $MY_ATABLE_ID=14030; 
  
        public static $DATABASE		= "nauss_adm";
        public static $MODULE		        = "adm";        
        public static $TABLE			= "cv_rubric_item";

	    public static $DB_STRUCTURE = null;
	
	    public function __construct(){
		parent::__construct("cv_rubric_item","id","adm");
            AdmCvRubricItemAfwStructure::initInstance($this);    
	    }
        
        public static function loadById($id)
        {
           $obj = new CvRubricItem();
