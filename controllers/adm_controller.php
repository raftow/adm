...
class AdmController extends AfwController{
        ...
        {
                return array("", "adm/employee_front_header.php", "lib/hzm/web/hzm_simple_footer.php");
        }
        ...
        public function checkEmployeeLoggedIn()
        {
                ...
                if(!$theEmployee)
                {
                    ...
                    $login_module = AfwSession::config("login_module","adm"); 
        ...
        public function view_school($request)
        {
                ...
                if($data["schoolObj"] and (!$data["schoolObj"]->isEmpty()))
                {
                        ...
                        else
                        {
                                ...
                                $this->render("adm", "view_school", $data);
                        }
        ...
        public function myschools($request)
        {
                ...
                if($data) $this->render("adm", "my_schools", $data);
                else return ;
