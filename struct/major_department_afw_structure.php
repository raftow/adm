<?php 
        class AdmMajorDepartmentAfwStructure
        {
        
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof MajorDepartment) 
                        {
                                $obj->QEDIT_MODE_NEW_OBJECTS_DEFAULT_NUMBER = 3;
                                //$obj->DISPLAY_FIELD = "major_department_name_ar";
                                //$obj->ORDER_BY_FIELDS = "xxxx, yyyy";
                                $obj->UNIQUE_KEY = array('major_id','department_id');
                                // $obj->public_display = true;

                                //$obj->editByStep = true;
                                //$obj->editNbSteps = 2; 
                                $obj->after_save_edit = array("class"=>'Department',"attribute"=>'department_id', "currmod"=>'adm',"currstep"=>2);
                        }
                }
                ...
                public static $DB_STRUCTURE = array(
                                        ...
                                        'major_id' => array('IMPORTANT' => 'IN',  'SEARCH' => true, 'QSEARCH' => true, 'SHOW' => true,  'RETRIEVE' => true,  
                                                ...
                                                'DISPLAY' => true,  'STEP' => 1,  'MANDATORY' => true, 'RELATION' => 'OneToMany',
                                                'DISPLAY-UGROUPS' => '',  'EDIT-UGROUPS' => '', 
                                                'CSS' => 'width_pct_25', ),	
