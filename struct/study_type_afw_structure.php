<?php 
        ...
        class AdmStudyTypeAfwStructure
        {
                // token separator = §
                ...
                $obj->general_check_errors = true;
                                // $obj->after_save_edit = array("class"=>'StudyType',"attribute"=>'xxxx_id', "currmod"=>'adm',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'adm', "class"=>'StudyType',"submit"=>true);
                        }
                        else 
                        {
                                StudyTypeArTranslator::initData();
                                StudyTypeEnTranslator::initData();
                        }
                }
