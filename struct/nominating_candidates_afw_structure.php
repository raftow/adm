...
class AdmNominatingCandidatesAfwStructure
{
	...
	public static function initInstance(&$obj)
	{
		if ($obj instanceof NominatingCandidates) {
			...
			$obj->DISPLAY_FIELD_BY_LANG = ['ar' => ['first_name_ar',  'last_name_ar'], 'en' => ['first_name_en',  'last_name_en']];
...
'birth_date' => array(
		...
		'candidateEvaluationList' => array(
			...
			'ANSMODULE' => 'adm',
			'WHERE' => 'applicant_id = §applicant_id§ and nomination_letter_id = §nomination_letter_id§',
			'READONLY' => true,
			'CAN-BE-SETTED' => true,
			'CSS' => 'width_pct_100',
		),
		...
		'applicationStatusShortcut' => array(
			'IMPORTANT' => 'IN',
			'SEARCH' => false,
			'QSEARCH' => false,
			'SHOW' => true,
