<?php 
        class AdmAcademicLevelOfferingAfwStructure
        {
        
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof AcademicLevelOffering) 
                        {
                                $obj->QEDIT_MODE_NEW_OBJECTS_DEFAULT_NUMBER = 3;
                                // $obj->DISPLAY_FIELD = "academic_level_offering_name_ar";
                                $obj->ORDER_BY_FIELDS = "academic_level_id, training_unit_id";
                                $obj->UNIQUE_KEY = array('academic_level_id','training_unit_id');
                                ...
                                // $obj->editByStep = true;
                                // $obj->editNbSteps = 2; 
                                $obj->after_save_edit = array("class"=>'TrainingUnit',"attribute"=>'training_unit_id', "currmod"=>'adm',"currstep"=>3);
                        }
                }
