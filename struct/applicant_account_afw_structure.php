...
class AdmApplicantAccountAfwStructure
{
        ...
        public static function initInstance(&$obj)
        {
                if ($obj instanceof ApplicantAccount) {
                        ...
                        $obj->UNIQUE_KEY = array('applicant_id', 'application_plan_id', 'application_simulation_id', 'application_model_financial_transaction_id');
        ...
        public static $DB_STRUCTURE = array(
                ...
                'application_model_financial_transaction_id' => array(
                        ...
                        'UTF8' => false,
                        'TYPE' => 'FK',
                        'ANSWER' => 'application_model_financial_transaction',
                        'ANSMODULE' => 'adm',
                        'SIZE' => 40,
                        'DEFAUT' => 0,
                        'DISPLAY' => true,
