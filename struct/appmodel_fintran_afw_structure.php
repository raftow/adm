<?php 
        class AdmAppmodelFintranAfwStructure
        {
        
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof AppmodelFintran) 
                        {
                                $obj->QEDIT_MODE_NEW_OBJECTS_DEFAULT_NUMBER = 3;
                                 $obj->DISPLAY_FIELD = "appmodel_fintran_name_ar";
                                // $obj->ORDER_BY_FIELDS = "xxxx, yyyy";
                                $obj->UNIQUE_KEY = array('fin_transaction_id','application_model_id');
                        ...
                        {
                                AppmodelFintranArTranslator::initData();
                                AppmodelFintranEnTranslator::initData();
                        }
                }
                ...
                public static $DB_STRUCTURE = array(
                                        ...
                                        'fin_transaction_id' => array('IMPORTANT' => 'IN',  'SEARCH' => true, 'QSEARCH' => true, 'SHOW' => true,  'RETRIEVE' => true,  
        'EDIT' => true,  'QEDIT' => true, 'SHOW-ADMIN' => true,  'EDIT-ADMIN' => true,  'UTF8' => false,  
        'TYPE' => 'FK',  'ANSWER' => 'fin_transaction',  'ANSMODULE' => 'adm',  'SIZE' => 40,  'DEFAUT' => 0,    
