<?php 
        ...
        class AdmStudyFundingStatusAfwStructure
        {
                // token separator = §
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof StudyFundingStatus ) 
                        {
                ...
                $obj->general_check_errors = true;
                                // $obj->after_save_edit = array("class"=>'StudyFundingStatus',"attribute"=>'xxxx_id', "currmod"=>'adm',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'adm', "class"=>'StudyFundingStatus',"submit"=>true);
                        }
                        else 
                        {
                                StudyFundingStatusArTranslator::initData();
                                StudyFundingStatusEnTranslator::initData();
                        }
                }
     ...
     array(
		...
		'payment_ind' => array('STEP' => 1,  'SEARCH' => false,  'QSEARCH' => false,  'SHOW' => true,  'AUDIT' => false,  'RETRIEVE' => true,  
				'EDIT' => true,  'QEDIT' => false,  
				'SIZE' => 32,  'MAXLENGTH' => 32,  'CHAR_TEMPLATE' => "ALPHABETIC,SPACE",  'UTF8' => false,  
