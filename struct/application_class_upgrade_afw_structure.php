<?php 
        ...
        class AdmApplicationClassUpgradeAfwStructure
        {
                // token separator = §
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof ApplicationClassUpgrade ) 
                        {
                                ...
                                $obj->UNIQUE_KEY = array('initial_applicant_class_id', 'sponsor_id');
                                $obj->editByStep = false;
                                $obj->editNbSteps = 0;
                                $obj->showQeditErrors = true;
                                $obj->showRetrieveErrors = true;
                                $obj->general_check_errors = true;
                                // $obj->after_save_edit = array("class"=>'ApplicationClassUpgrade',"attribute"=>'xxxx_id', "currmod"=>'adm',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'adm', "class"=>'ApplicationClassUpgrade',"submit"=>true);
                        }
                        else 
                        {
                                ApplicationClassUpgradeArTranslator::initData();
                                ApplicationClassUpgradeEnTranslator::initData();
                        }
                }
     ...
     array(
		...
		'sponsor_id' => array('STEP' => 1,  'SHORTNAME' => 'sponsor',  'SEARCH' => true,  'QSEARCH' => false,  'SHOW' => true,  'AUDIT' => false,  'RETRIEVE' => true,  
				...
				'RELATION' => 'unkn',  'READONLY' => false,  'DNA' => true, 
				'CSS' => 'width_pct_50', ),
                'final_applicant_class_id' => array('STEP' => 1,  'SHORTNAME' => 'class',  'SEARCH' => true,  'QSEARCH' => false,  'SHOW' => true,  'AUDIT' => false,  'RETRIEVE' => true,  
				'EDIT' => true,  'QEDIT' => true,  
				'SIZE' => 32,  'MAXLENGTH' => 32,  'MIN-SIZE' => 1,  'CHAR_TEMPLATE' => "ALPHABETIC,SPACE",  'MANDATORY' => true,  'UTF8' => false,  
				'TYPE' => 'FK',  'ANSWER' => 'application_class',  'ANSMODULE' => 'adm',  
				'RELATION' => 'unkn',  'READONLY' => false,  'DNA' => true, 
