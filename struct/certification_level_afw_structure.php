<?php 
        ...
        class AdmCertificationLevelAfwStructure
        {
                // token separator = §
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof CertificationLevel ) 
                        {
                ...
                $obj->general_check_errors = true;
                                // $obj->after_save_edit = array("class"=>'CertificationLevel',"attribute"=>'xxxx_id', "currmod"=>'adm',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'adm', "class"=>'CertificationLevel',"submit"=>true);
                        }
                        else 
                        {
                                CertificationLevelArTranslator::initData();
                                CertificationLevelEnTranslator::initData();
                        }
                }
     ...
     array(
		...
		'desc_en' => array('SEARCH' => true,  'QSEARCH' => true,  'SHOW' => true,  'AUDIT' => false,  'RETRIEVE' => false,  
                ...
                'scoring_multiplier' => array('SEARCH' => true,  'QSEARCH' => true,  'SHOW' => true,  'AUDIT' => false,  'RETRIEVE' => true,  
                'EDIT' => true,  'QEDIT' => true,  
                'SIZE' => 128,  'MAXLENGTH' => 128,  'MIN-SIZE' => 5,  'CHAR_TEMPLATE' => "ALPHABETIC,SPACE",  'MANDATORY' => true,  'UTF8' => false,  
                'TYPE' => 'TEXT',  'READONLY' => false, 
                'CSS' => 'width_pct_50', ),
