<?php 
        class AdmFintransPaymentAfwStructure
        {
        
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof FintransPayment) 
                        {
                        ...
                        {
                                FintransPaymentArTranslator::initData();
                                FintransPaymentEnTranslator::initData();
                        }
                }
                ...
                public static $DB_STRUCTURE = array(
                                        ...
                                        'applicant_fintrans_id' => array('IMPORTANT' => 'IN',  'SEARCH' => true, 'QSEARCH' => true, 'SHOW' => true,  'RETRIEVE' => true,  
        'EDIT' => true,  'QEDIT' => true, 'SHOW-ADMIN' => true,  'EDIT-ADMIN' => true,  'UTF8' => false,  
        'TYPE' => 'FK',  'ANSWER' => 'applicant_fintrans',  'ANSMODULE' => 'adm',  'SIZE' => 40,  'DEFAUT' => 0,    
