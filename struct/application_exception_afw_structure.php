<?php 
        ...
        class AdmApplicationExceptionAfwStructure
        {
                // token separator = §
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof ApplicationException ) 
                        {
                                ...
                                $obj->DISPLAY_FIELD_BY_LANG = ['ar'=>array('applicant_id', 'application_plan_id'), 'en'=>array('applicant_id', 'application_plan_id')];
                                ...
                                $obj->ORDER_BY_FIELDS = "";
                                 ...
                                 $obj->UNIQUE_KEY = array('applicant_id', 'application_plan_id','application_simulation_id','expiry_date');
                                
                $obj->showQeditErrors = true;
                $obj->showRetrieveErrors = true;
                $obj->general_check_errors = true;
                                // $obj->after_save_edit = array("class"=>'ApplicationException',"attribute"=>'xxxx_id', "currmod"=>'adm',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'adm', "class"=>'ApplicationException',"submit"=>true);
                        }
                        else 
                        {
                                ApplicationExceptionArTranslator::initData();
                                ApplicationExceptionEnTranslator::initData();
                        }
                }
     ...
     array(
		...
		'application_simulation_id' => array('SHORTNAME' => 'simulation',  'SEARCH' => true,  'QSEARCH' => false,  'SHOW' => true,  'AUDIT' => false,  'RETRIEVE' => true,  
				'EDIT' => true,  'QEDIT' => true,  
				'SIZE' => 32,  'MAXLENGTH' => 32,  'MIN-SIZE' => 1,  'CHAR_TEMPLATE' => "ALPHABETIC,SPACE",  'MANDATORY' => true,  'UTF8' => false,  
