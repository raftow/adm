<?php 
        ...
        class AdmSisLevelCodeAfwStructure
        {
                // token separator = §
                ...
                $obj->general_check_errors = true;
                                // $obj->after_save_edit = array("class"=>'SisLevelCode',"attribute"=>'xxxx_id', "currmod"=>'adm',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'adm', "class"=>'SisLevelCode',"submit"=>true);
                        }
                        else 
                        {
                                SisLevelCodeArTranslator::initData();
                                SisLevelCodeEnTranslator::initData();
                        }
                }
