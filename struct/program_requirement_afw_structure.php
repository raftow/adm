...
class AdmProgramRequirementAfwStructure
{
        // token separator = §
        public static function initInstance(&$obj)
        {
                if ($obj instanceof ProgramRequirement) {
                        ...
                        // $obj->after_save_edit = array("class"=>'ProgramRequirement',"attribute"=>'xxxx_id', "currmod"=>'adm',"currstep"=>2);
                        $obj->after_save_edit = array('mode' => 'qsearch', 'currmod' => 'adm', 'class' => 'ProgramRequirement', 'submit' => true);
                } else {
                        ProgramRequirementArTranslator::initData();
                        ProgramRequirementEnTranslator::initData();
                }
        }
        ...
        array(
                ...
                'application_category_enum' => array(
                        ...
                        'TYPE' => 'ENUM',
                        'ANSWER' => 'FUNCTION',
                        'FUNCTION_COL_NAME' => 'workflow_category_enum',
                        'DEFAUT' => '1',
                        'READONLY' => false,
                        'DNA' => true,
                        'CSS' => 'width_pct_25',
                ...
                'application_requirement_mfk' => array(
                        ...
                        'UTF8' => false,
                        'TYPE' => 'MFK',
                        'ANSWER' => 'application_requirement',
                        'ANSMODULE' => 'adm',
                        'READONLY' => false,
                        'DNA' => true,
                        'CSS' => 'width_pct_100',
