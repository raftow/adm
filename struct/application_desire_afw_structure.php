        ...
        class AdmApplicationDesireAfwStructure
        {
                ...
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof ApplicationDesire) 
                        {
                                ...
                                $obj->UNIQUE_KEY = array('applicant_id','application_plan_id','application_plan_branch_id');
...
'application_id' => array('IMPORTANT' => 'IN',  'SEARCH' => true, 'QSEARCH' => true, 'SHOW' => true,  'RETRIEVE' => true,  
        ...
        'DISPLAY' => true,  'STEP' => 1,  'RELATION' => 'ManyToOne-OneToMany', 'MANDATORY' => true, 'READONLY'=>false, 'AUTOCOMPLETE' => true,
        'DISPLAY-UGROUPS' => '',  'EDIT-UGROUPS' => '', 
        'CSS' => 'width_pct_25', ),	
