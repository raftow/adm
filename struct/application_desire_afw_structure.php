<?php 
        class AdmApplicationDesireAfwStructure
        {
                ...
                public static $DB_STRUCTURE = array(
                                        ...
                                        'applicant_id' => array('IMPORTANT' => 'IN',  'SEARCH' => false, 'QSEARCH' => false, 'SHOW' => true,  
                                                'RETRIEVE' => true, 'EDIT' => true,  'QEDIT' => true, 'SHOW-ADMIN' => true,  
                                                'EDIT-ADMIN' => true,  'UTF8' => false, 'READONLY'=>true, 'AUTOCOMPLETE' => false, 
                                        ...
                                        'applicant_qualification_id' => array('IMPORTANT' => 'IN',  'SEARCH' => true, 'QSEARCH' => false, 'SHOW' => false,  'RETRIEVE' => false,  
                                                ...
                                                'DISPLAY' => true,  'STEP' => 1,  'RELATION' => 'ManyToOne', 'MANDATORY' => false, 'READONLY'=>true, 'AUTOCOMPLETE' => true,'AUTOCOMPLETE-SEARCH'=> true,
                                                'DISPLAY-UGROUPS' => '',  'EDIT-UGROUPS' => '', 
                                                'CSS' => 'width_pct_25', ),	
								...
								'CSS' => 'width_pct_100',),
                                        ...
                                        'sorting_field_1_id' => array(
                                                'CATEGORY' => 'SHORTCUT',
                                                'SHORTCUT' => 'sorting_group_id.sorting_field_1_id',
                                                'STEP' => 5, 
                                                'SEARCH' => true,
                                                'QSEARCH' => false,
                                                'SHOW' => true,
                                        ...
                                        'sorting_field_2_id' => array(
                                                'CATEGORY' => 'SHORTCUT',
                                                'SHORTCUT' => 'sorting_group_id.sorting_field_2_id',
                                                'STEP' => 5, 
                                                'SEARCH' => true,
                                                'QSEARCH' => false,
                                                'SHOW' => true,
                                        ...
                                        'sorting_field_3_id' => array(
                                                'CATEGORY' => 'SHORTCUT',
                                                'SHORTCUT' => 'sorting_group_id.sorting_field_3_id',
                                                'STEP' => 5, 
                                                'SEARCH' => true,
                                                'QSEARCH' => false,
                                                'SHOW' => true,
