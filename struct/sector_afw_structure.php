<?php 
        ...
        class AdmSectorAfwStructure
        {
                ...
                $obj->general_check_errors = true;
                                // $obj->after_save_edit = array("class"=>'Sector',"attribute"=>'xxxx_id', "currmod"=>'adm',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'adm', "class"=>'Sector',"submit"=>true);
                        }
                        else 
                        {
                                SectorArTranslator::initData();
                                SectorEnTranslator::initData();
                        }
                }
