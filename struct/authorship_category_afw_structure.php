<?php 
        ...
        class AdmAuthorshipCategoryAfwStructure
        {
                // token separator = §
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof AuthorshipCategory ) 
                        {
                ...
                $obj->general_check_errors = true;
                                // $obj->after_save_edit = array("class"=>'AuthorshipCategory',"attribute"=>'xxxx_id', "currmod"=>'adm',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'adm', "class"=>'AuthorshipCategory',"submit"=>true);
                        }
                        else 
                        {
                                AuthorshipCategoryArTranslator::initData();
                                AuthorshipCategoryEnTranslator::initData();
                        }
                }
     ...
     array(
		...
		'scoring_multiplier' => array('SEARCH' => true,  'QSEARCH' => false,  'SHOW' => true,  'AUDIT' => false,  'RETRIEVE' => true,  
				'EDIT' => true,  'QEDIT' => false,  
				'SIZE' => 9999,  'MAXLENGTH' => 32,  'MIN-SIZE' => 1,  'CHAR_TEMPLATE' => "ALPHABETIC,SPACE",  'MANDATORY' => true,  'FORMAT' => '*.2',  'UTF8' => false,  
