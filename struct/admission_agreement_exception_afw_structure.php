<?php 
        class AdmAdmissionAgreementExceptionAfwStructure
        {
        
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof AdmissionAgreementException) 
                        {
                                $obj->QEDIT_MODE_NEW_OBJECTS_DEFAULT_NUMBER = 3;
                                $obj->DISPLAY_FIELD = "admission_agreement_exception_name_ar";
                                // $obj->ORDER_BY_FIELDS = "xxxx, yyyy";
                                $obj->UNIQUE_KEY = array('admission_agreement_plan_id','acondition_id');
