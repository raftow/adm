<?php 
        ...
        class AdmCvRubricGuideAfwStructure
        {
                // token separator = §
                ...
                $obj->general_check_errors = true;
                                // $obj->after_save_edit = array("class"=>'CvRubricGuide',"attribute"=>'xxxx_id', "currmod"=>'adm',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'adm', "class"=>'CvRubricGuide',"submit"=>true);
                        }
                        else 
                        {
                                CvRubricGuideArTranslator::initData();
                                CvRubricGuideEnTranslator::initData();
                        }
                }
     ...
     array(
		...
		'rubric_desc' => array('SEARCH' => true,  'QSEARCH' => true,  'SHOW' => true,  'AUDIT' => false,  'RETRIEVE' => false,  
				'EDIT' => true,  'QEDIT' => false,  
