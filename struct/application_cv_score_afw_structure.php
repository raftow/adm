...
class AdmApplicationCvScoreAfwStructure
{
	...
	array(
		...
		'score_QUAL' => array(
			...
			'CSS' => 'width_pct_50',
			'STEP' => 2,
			'CONSTRAINTS' => ['i-between;0,100'],
		),

		'review_date_QUAL' => array(
			'SEARCH' => false,
			'QSEARCH' => false,
			'SHOW' => false,
			'AUDIT' => false,
