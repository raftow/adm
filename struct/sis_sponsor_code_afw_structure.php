<?php 
        ...
        class AdmSisSponsorCodeAfwStructure
        {
                // token separator = §
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof SisSponsorCode ) 
                        {
                ...
                $obj->general_check_errors = true;
                                // $obj->after_save_edit = array("class"=>'SisSponsorCode',"attribute"=>'xxxx_id', "currmod"=>'adm',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'adm', "class"=>'SisSponsorCode',"submit"=>true);
                        }
                        else 
                        {
                                SisSponsorCodeArTranslator::initData();
                                SisSponsorCodeEnTranslator::initData();
                        }
                }
