<?php 
        ...
        class AdmConferenceRoleAfwStructure
        {
                // token separator = §
                ...
                $obj->general_check_errors = true;
                                // $obj->after_save_edit = array("class"=>'ConferenceRole',"attribute"=>'xxxx_id', "currmod"=>'adm',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'adm', "class"=>'ConferenceRole',"submit"=>true);
                        }
                        else 
                        {
                                ConferenceRoleArTranslator::initData();
                                ConferenceRoleEnTranslator::initData();
                        }
                }
