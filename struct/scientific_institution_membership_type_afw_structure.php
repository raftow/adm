<?php 
        ...
        class AdmScientificInstitutionMembershipTypeAfwStructure
        {
                // token separator = §
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof ScientificInstitutionMembershipType ) 
                        {
                                ...
                                // $obj->after_save_edit = array("class"=>'ScientificInstitutionMembershipType',"attribute"=>'xxxx_id', "currmod"=>'adm',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'adm', "class"=>'ScientificInstitutionMembershipType',"submit"=>true);
                        }
                        else 
                        {
                                ScientificInstitutionMembershipTypeArTranslator::initData();
                                ScientificInstitutionMembershipTypeEnTranslator::initData();
                        }
                }
