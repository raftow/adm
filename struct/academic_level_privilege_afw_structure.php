<?php 
        class AdmAcademicLevelPrivilegeAfwStructure
        {
        
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof AcademicLevelPrivilege) 
                        {
                                $obj->QEDIT_MODE_NEW_OBJECTS_DEFAULT_NUMBER = 3;
                                $obj->DISPLAY_FIELD = "academic_level_privilege_name_ar";
                                ...
                                $obj->editByStep = true;
                                $obj->editNbSteps = 2; 
                                $obj->after_save_edit = array("class"=>'AcademicLevel',"attribute"=>'academic_level_id', "currmod"=>'adm',"currstep"=>3);
                        }
                }
