<?php 
        ...
        class AdmApplicationClassAfwStructure
        {
                // token separator = §
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof ApplicationClass ) 
                        {
                                ...
                                // $obj->after_save_edit = array("class"=>'ApplicationClass',"attribute"=>'xxxx_id', "currmod"=>'adm',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'adm', "class"=>'ApplicationClass',"submit"=>true);
                        }
                        else 
                        {
                                ApplicationClassArTranslator::initData();
                                ApplicationClassEnTranslator::initData();
                        }
                }
     ...
     array(
		...
		'desc_en' => array('STEP' => 1,  'SEARCH' => true,  'QSEARCH' => true,  'SHOW' => true,  'AUDIT' => false,  'RETRIEVE' => false,  
                ...
                'budgeting_ind' => array('STEP' => 1,  'SEARCH' => true,  'QSEARCH' => true,  'SHOW' => true,  'AUDIT' => false,  'RETRIEVE' => true,
                                ...
                                'CSS' => 'width_pct_25', ),
                'scholarship_ind' => array('STEP' => 1,  'SEARCH' => true,  'QSEARCH' => true,  'SHOW' => true,  'AUDIT' => false,  'RETRIEVE' => true,
                                'EDIT' => true,  'QEDIT' => false,
                                'SIZE' => 32,  'MAXLENGTH' => 32,  'MIN-SIZE' => 1,  'CHAR_TEMPLATE' => "ALPHABETIC,SPACE",  'MANDATORY' => false,  'UTF8' => false,
                                'TYPE' => 'YN',    'READONLY' => false,  'DNA' => true,
                                'CSS' => 'width_pct_25', ),
