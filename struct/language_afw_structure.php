<?php 
        ...
        class AdmLanguageAfwStructure
        {
                ...
                $obj->general_check_errors = true;
                                // $obj->after_save_edit = array("class"=>'Language',"attribute"=>'xxxx_id', "currmod"=>'adm',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'adm', "class"=>'Language',"submit"=>true);
                        }
                        else 
                        {
                                LanguageArTranslator::initData();
                                LanguageEnTranslator::initData();
                        }
                }
