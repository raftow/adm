...
class AdmDisabilityAfwStructure
{
        // token separator = §
        public static function initInstance(&$obj)
        {
                if ($obj instanceof Disability) {
                        ...
                        $obj->after_save_edit = array("mode" => "qsearch", "currmod" => 'adm', "class" => 'Disability', "submit" => true);
                } else {
                        DisabilityArTranslator::initData();
                        DisabilityEnTranslator::initData();
                }
        }
