<?php 
        ...
        class AdmProficiencyLevelAfwStructure
        {
                // token separator = §
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof ProficiencyLevel ) 
                        {
                ...
                $obj->general_check_errors = true;
                                // $obj->after_save_edit = array("class"=>'ProficiencyLevel',"attribute"=>'xxxx_id', "currmod"=>'adm',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'adm', "class"=>'ProficiencyLevel',"submit"=>true);
                        }
                        else 
                        {
                                ProficiencyLevelArTranslator::initData();
                                ProficiencyLevelEnTranslator::initData();
                        }
                }
