<?php 
        class AdmApplicationRecommendationAfwStructure
        {
                ...
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof ApplicationRecommendation) 
                        {
                                $obj->QEDIT_MODE_NEW_OBJECTS_DEFAULT_NUMBER = 3;
                                 $obj->DISPLAY_FIELD = "application_recommendation_name_ar";
                                // $obj->ORDER_BY_FIELDS = "xxxx, yyyy";
                                $obj->UNIQUE_KEY = array('recommendation_letter_id','application_id');
                        ...
                        {
                                ApplicationRecommendationArTranslator::initData();
                                ApplicationRecommendationEnTranslator::initData();
                        }
                }
                ...
                public static $DB_STRUCTURE = array(
                                        ...
                                        'recommendation_letter_id' => array('IMPORTANT' => 'IN',  'SEARCH' => true, 'QSEARCH' => true, 'SHOW' => true,  'RETRIEVE' => true,  
        'EDIT' => true,  'QEDIT' => true, 'SHOW-ADMIN' => true,  'EDIT-ADMIN' => true,  'UTF8' => false,  
        'TYPE' => 'FK',  'ANSWER' => 'recommendation_letter',  'ANSMODULE' => 'adm',  'SIZE' => 40,  'DEFAUT' => 0,    
...
'application_id' => array(
        ...
        'QEDIT' => true,
        'EDIT' => true,
        'TYPE' => 'FK','ANSWER'=>'application','module'=>'adm', 'MANDATORY' => true, 
        'STEP' => 1,
        'DISPLAY-UGROUPS' => '',
        'EDIT-UGROUPS' => '',
        'CSS' => 'width_pct_25',),
...
'lor_status_enum' => array('RETRIEVE' => true, 'SHOW' => true, 'EDIT' => true,  'DEFAUT' => '',  
...
'notification_sent' => array('RETRIEVE' => true, 'SHOW' => true, 'EDIT' => true,  'DEFAUT' => 'N',  
...
'notification_type_enum' => array('IMPORTANT' => 'IN',  'SEARCH' => true, 'QSEARCH' => true, 'SHOW' => true,  'RETRIEVE-AR' => true,  
...
'approval_user_id' => array('IMPORTANT' => 'IN',  'SEARCH' => true, 'QSEARCH' => true, 'SHOW' => true,  'RETRIEVE' => true,  
        'EDIT' => true,  'QEDIT' => true, 'SHOW-ADMIN' => true,  'EDIT-ADMIN' => true,  'UTF8' => false,  
