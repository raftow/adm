<?php 
        class AdmQualSourceAfwStructure
        {
        
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof QualSource) 
                        {
                                $obj->QEDIT_MODE_NEW_OBJECTS_DEFAULT_NUMBER = 3;
                                $obj->DISPLAY_FIELD = "qual_source_name_ar";
                                // $obj->ORDER_BY_FIELDS = "xxxx, yyyy";
                                // $obj->UNIQUE_KEY = array('qual_source_name_ar','qual_source_name_en');
                                // $obj->public_display = true;
                                // $obj->IS_LOOKUP = true;

                                $obj->editByStep = false;
                                // $obj->editNbSteps = 1; 
                                $obj->after_save_edit = array("class"=>'Qualification',"attribute"=>'qualification_id', "currmod"=>'adm',"currstep"=>2);
                        }
                }
                ...
                public static $DB_STRUCTURE = array(
                                        ...
                                        'qual_source_name_ar' => array('IMPORTANT' => 'IN',  'SEARCH' => true, 'QSEARCH' => true, 'SHOW' => true,  'RETRIEVE' => true,  
                                        ...
                                        'qual_source_name_en' => array('IMPORTANT' => 'IN',  'SEARCH' => true, 'QSEARCH' => true, 'SHOW' => true,  'RETRIEVE' => true,  
