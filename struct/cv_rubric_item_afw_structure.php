<?php 
        ...
        class AdmCvRubricItemAfwStructure
        {
                // token separator = §
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof CvRubricItem ) 
                        {
                ...
                $obj->general_check_errors = true;
                                // $obj->after_save_edit = array("class"=>'CvRubricItem',"attribute"=>'xxxx_id', "currmod"=>'adm',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'adm', "class"=>'CvRubricItem',"submit"=>true);
                        }
                        else 
                        {
                                CvRubricItemArTranslator::initData();
                                CvRubricItemEnTranslator::initData();
                        }
                }
