        ...
        class AdmApplicantScholarshipAfwStructure
        {
                ...
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof ApplicantScholarship) 
                        {
                                ...
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'adm', "class"=>'ApplicantScholarship',"submit"=>true);
                        }
                        else 
                        {
...
'applicant_scholarship_status_id' => array(
        ...
        'TYPE' => 'FK',  'ANSWER' => 'applicant_scholarship_status',  'ANSMODULE' => 'adm', 'MANDATORY' => false, 
        'STEP' => 1,
        'DISPLAY' => true,
        'EDIT-UGROUPS' => '',
        'CSS' => 'width_pct_25',),
