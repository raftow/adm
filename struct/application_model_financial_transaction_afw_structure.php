...
class AdmApplicationModelFinancialTransactionAfwStructure
{
        ...
        public static function initInstance(&$obj)
        {
                if ($obj instanceof ApplicationModelFinancialTransaction) {
                        ...
                        $obj->DISPLAY_FIELD = array('application_model_id', 'financial_transaction_id');
                        // $obj->ORDER_BY_FIELDS = "xxxx, yyyy";
                        $obj->UNIQUE_KEY = array('application_model_id', 'financial_transaction_id');
        ...
        public static $DB_STRUCTURE = array(
                ...
                'financial_transaction_mfk' => array(
                        'IMPORTANT' => 'HIGH',
                        'SHOW' => true,
                        'RETRIEVE' => true,
                        'EDIT' => true,
