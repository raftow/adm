...
class AdmApplicantSimulationAfwStructure
{
        // token separator = §
        public static function initInstance(&$obj)
        {
                if ($obj instanceof ApplicantSimulation) {
                        $obj->QEDIT_MODE_NEW_OBJECTS_DEFAULT_NUMBER = 15;
                        $obj->DISPLAY_FIELD = array('application_simulation_id', 'applicant_id');

                        // $obj->ENABLE_DISPLAY_MODE_IN_QEDIT=true;
                        $obj->ORDER_BY_FIELDS = "application_simulation_id, done desc, applicant_id";



                        $obj->UNIQUE_KEY = array('application_simulation_id', 'applicant_id');

                        $obj->showQeditErrors = true;
                        $obj->showRetrieveErrors = true;
                        $obj->general_check_errors = true;
                        // $obj->after_save_edit = array("class"=>'Road',"attribute"=>'road_id', "currmod"=>'btb',"currstep"=>9);
                        $obj->after_save_edit = array("mode" => "qsearch", "currmod" => 'adm', "class" => 'ApplicantSimulation', "submit" => true);
                } else {
                        ApplicantSimulationArTranslator::initData();
                        ApplicantSimulationEnTranslator::initData();
                }
        }
        ...
        array(
                ...
                'decided'     => array('HIDE_IF_NEW' => true, 'SHOW' => true, 'RETRIEVE' => true, 'EDIT' => true, 'QEDIT' => true, 
                                "DEFAULT" => 'N', 'TYPE' => 'YN', 'CSS' => 'width_pct_25',),
