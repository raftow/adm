<?php 
        ...
        class AdmSisMajorCodeAfwStructure
        {
                // token separator = §
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof SisMajorCode ) 
                        {
                                ...
                                $obj->IS_LOOKUP = true;
                                 $obj->UNIQUE_KEY = array('lookup_code', 'sis_program_code_id');
                                $obj->editByStep = false;
                $obj->editNbSteps = 0;
                $obj->showQeditErrors = true;
                $obj->showRetrieveErrors = true;
                $obj->general_check_errors = true;
                                // $obj->after_save_edit = array("class"=>'SisMajorCode',"attribute"=>'xxxx_id', "currmod"=>'adm',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'adm', "class"=>'SisMajorCode',"submit"=>true);
                        }
                        else 
                        {
                                SisMajorCodeArTranslator::initData();
                                SisMajorCodeEnTranslator::initData();
                        }
                }
     ...
     array(
		...
		'sis_program_code_id' => array('STEP' => 1,  'SHORTNAME' => 'program_code',  'SEARCH' => true,  'QSEARCH' => false,  'SHOW' => true,  'AUDIT' => false,  'RETRIEVE' => true,  
				'EDIT' => true,  'QEDIT' => true,  
				'SIZE' => 32,  'MAXLENGTH' => 32,  'MIN-SIZE' => 1,  'CHAR_TEMPLATE' => "ALPHABETIC,SPACE",  'MANDATORY' => true,  'UTF8' => false,  
				'TYPE' => 'FK',  'ANSWER' => 'sis_program_code',  'ANSMODULE' => 'adm',  
