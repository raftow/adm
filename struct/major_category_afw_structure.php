<?php 
        class AdmMajorCategoryAfwStructure
        {
                ...
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof MajorCategory) 
                        {
                                ...
                                $obj->DISPLAY_FIELD = "major_category_name_ar";
                                $obj->ORDER_BY_FIELDS = "major_category_name_ar";
                                $obj->UNIQUE_KEY = array('major_category_name_ar');
                                $obj->public_display = true;
                                $obj->IS_LOOKUP = true;

                                $obj->editByStep = false;
                                $obj->editNbSteps = 0; 
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'adm', "class"=>'MajorCategory',"submit"=>true);
                ...
                public static $DB_STRUCTURE = array(
                                        ...
                                        'major_category_name_ar' => array('IMPORTANT' => 'IN',  'SEARCH' => true, 'QSEARCH' => true, 'SHOW' => true,  'RETRIEVE-AR' => true,  
                                        ...
                                        'major_category_name_en' => array('IMPORTANT' => 'IN',  'SEARCH' => true, 'QSEARCH' => true, 'SHOW' => true,  'RETRIEVE-EN' => true,  
