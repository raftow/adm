<?php 
        ...
        class AdmLorTypeAfwStructure
        {
                // token separator = §
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof LorType ) 
                        {
                ...
                $obj->general_check_errors = true;
                                // $obj->after_save_edit = array("class"=>'LorType',"attribute"=>'xxxx_id', "currmod"=>'adm',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'adm', "class"=>'LorType',"submit"=>true);
                        }
                        else 
                        {
                                LorTypeArTranslator::initData();
                                LorTypeEnTranslator::initData();
                        }
                }
