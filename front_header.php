...
$theCustomer = AfwSession::getCustomerConnected(true);
...
if(!$theCustomer)
{
     ...
     if(!$login_out_page) $login_out_page = "customer_login.php";
...
else
{
     ...
     if(!$login_out_page) $login_out_page = "customer_logout.php";
     ...
     $login_out_title = AfwLanguageHelper::translateKeyword("LOGOUT", $lang);    
                ...
                if($theCustomer)
                {
                        $welcome = $theCustomer->translate("welcome",$lang);
                        $firstname = $theCustomer->getVal("first_name_ar");
                        $lastname = $theCustomer->getVal("last_name_ar");
        ...
        <div class="container-fluid">
                <ul class="hzm_front_menu_bar hzm_front_menu_bar nav navbar-nav">
                        ...
                        <?php
                                ...
                                {
                                        if($theCustomer or $rowMenu["guest"])
                                        {
                        ?>
