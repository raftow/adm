...
class ServiceRequestArTranslator
{
	...
	public static function initData()
	{
		...
		$trad["service_request"]["servicerequest.single"] = "طلب دعم";
		$trad["service_request"]["servicerequest.new"] = "جديد";
		$trad["service_request"]["service_request"] = "طلبات الدعم";
		...
		$trad["service_request"]["request_status_id"] = "تحديث حالة الطلب";
		//$trad["service_request"]["request_type_id"] = " الطلب";
		$trad["service_request"]["status_comment"] = "رد موظف القبول";
